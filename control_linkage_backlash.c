...
{
	data->freq = 10000.000000; //Частота интегрирования
	data->tick_num = 0; 
	data->data0 = 0.000000;
	data->data1 = 0.000000;
	data->data2 = 0.000000;
...
//Функция рассчета нелинейности типа люфт
void control_linkage_backlash_tick( control_linkage_backlash_DATA *data )
{
	...
	data->data0 = stack[0];
	stack[0] = data->data0;
	stack[1] = M_PI/120 ; //Величина люфта в прямом направлении
	...
	stack[0] = stack[1]*stack[0];
	stack[1] = data->data0;
	stack[2] = -1*M_PI/120; //Величина люфта в обратном направлении
