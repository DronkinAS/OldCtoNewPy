...
{
    float D=1.0,q=1.0,U,a=1.0,z,f=2000.0;
...
int main(int argc, char** argv) {
    float z,dt,g1,g2,t,m,dU,tr1,tr2,i,j,meanvel, fulltime = 80, L = 20000;
    float *x, *k1, *k2, *k3, *k4;
    int n;
    ...
    z=fabs(x[0]-x[1]);
    dt = 0.001; m = 1.0;
    for (i = -3.0; i <= 3.0; i = (i + 0.01))
    {
        for (j = -2.0; j <= 2.0; j = (j + 0.01))
        {
            x[1] = i; x[3] = j;
            x[0]=0; x[2]=1.0;
            meanvel = 0;
