    ...
    for ( t = 0.0 ; t <= 1.0 ; t = t + dt )
    {
        ...
        *(error + 1) = ideal - angle_l;
        ...
        if ( fabs(*(error + 1)) > 10.0 )
        {
           ...
           correction_w (0.0001,0.05,"W1.dat","dW1.dat",W1,dW1,delta_4,in,60,7);
           correction_w (0.0001,0.05,"W2.dat","dW2.dat",W2,dW2,delta_3,L1,100,60);
           correction_w (0.0001,0.5,"W3.dat","dW3.dat",W3,dW3,delta_2,L2,100,100);
           correction_w (0.0001,0.5,"W4.dat","dW4.dat",W4,dW4,delta_1,L3,60,100);
           correction_w (0.0001,0.5,"W5.dat","dW5.dat",W5,dW5,delta_0,L4,1,60);
           
           correction_b (0.0001,0.5,"b1.dat","db1.dat",b1,db1,delta_4,60);
           correction_b (0.0001,0.5,"b2.dat","db2.dat",b2,db2,delta_3,100);
           correction_b (0.0001,0.5,"b3.dat","db3.dat",b3,db3,delta_2,100);
           correction_b (0.0001,0.5,"b4.dat","db4.dat",b4,db4,delta_1,60);
           correction_b (0.0001,0.5,"b5.dat","db5.dat",b5,db5,delta_0,1);
